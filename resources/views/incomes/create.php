...
<body>
    ...
    <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="date" id="date" placeholder="2023-06-21 09:10:44">
            </div>
            ...
            <div class="input-group">
                ...
                <textarea name="description" id="description" placeholder="Añade una descripción de tu ingreso"></textarea>
            </div>
